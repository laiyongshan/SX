...
public class ColorArcProgressBar extends View{
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color1 = a.getColor(R.styleable.ColorArcProgressBar_front_color1, Color.parseColor("#4bec05"));
        int color2 = a.getColor(R.styleable.ColorArcProgressBar_front_color2, Color.parseColor("#ffff00"));
        int color3 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, Color.parseColor("#ff7e00"));
        int color4 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, Color.parseColor("#ff0000"));
        int color5 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, Color.parseColor("#99004c"));
        int color6 = a.getColor(R.styleable.ColorArcProgressBar_front_color3, Color.parseColor("#7e0023"));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height= (int) (2 * longdegree + progressWidth + diameter + 2 * DEGREE_PROGRESS_DISTANCE-20);
        setMeasuredDimension(width, height);
    }

    private void initView() {

        diameter = (int) (12* getScreenWidth() /36);
        //弧形的矩阵区域
        bgRect = new RectF();
        bgRect.top = longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE-40;
        bgRect.left = longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE;
        bgRect.right = diameter + (longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE);
        bgRect.bottom = diameter + (longdegree + progressWidth/2 + DEGREE_PROGRESS_DISTANCE)-40;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedContent) {
            canvas.drawText(String.format("%.0f", curValues2)+"", centerX, centerY + textSize / 3-66, vTextPaint);
