...
import suncere.shanxi.androidapp.presenter.MapPresenter;
import suncere.shanxi.androidapp.ui.iview.IMapView;
...
public class MapFragment extends MvpFragment<MapPresenter> implements IMapView, AMap.OnMarkerClickListener, AMap.InfoWindowAdapter, AMap.OnInfoWindowClickListener {
    ...
    //网络请求参数
    String mdataType = "0";  //0为站点、1为区县、2为城市
    ...
    private String[] mTitles = {"国控", "省控", "城市", "区县"};
...
//    SegmentControl map_cityorcounty_segmentControl;
    ...
    public void initView(Bundle savedInstanceState, View view) {
        ...
        mLatLng = new LatLng(37.8195, 112.57);
        maMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mLatLng, 6.8f));
        ...
        map_segmentControl.setOnSegmentControlClickListener(new SegmentControl.OnSegmentControlClickListener() {
            ...
            public void onSegmentControlClick(int index) {
                switch (index) {
                    ...
                    case 0: //国控 mStationTypeId="1" ，mdataType="0";
                        mStationTypeId = "1";
                        mdataType = "0";
                        break;
                    case 1: //省控 mStationTypeId="2"， mdataType="0";
                        mStationTypeId = "2";
                        mdataType = "0";
                        break;
                    case 2: //城市 mdataType="2"
                        mdataType = "2";
                        break;
                    case 3: //区县 mdataType="1"
                        mdataType = "1";
                        break;
                }
                getData();
...
//        maMap.clear();
    ...
    private View creatMarkView(MapBean bean) {
        ...
        if(bean.getLevel().equals("2")){//良
            value_tv.setTextColor(Color.parseColor("#555555"));
        }else{
            value_tv.setTextColor(Color.WHITE);
        }
