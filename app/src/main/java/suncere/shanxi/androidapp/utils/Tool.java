...
import suncere.shanxi.androidapp.customview.DateTimeTool;
...
public class Tool {
	...
	public static CharSequence[] getCitys() {
		//"甘肃12城市",
		CharSequence[] citys = new CharSequence[] {"兰州市", "嘉峪关市", "金昌市",
				"武威市", "酒泉市", "张掖市", "定西市", "天水市", "白银市", "平凉市", "临夏回族自治州", "庆阳市",
				"陇南市", "甘南藏族自治州" };
	...
	public static String[] getCitys2() {
		//"甘肃12城市",
		String[] citys = new String[] {"兰州市", "嘉峪关市", "金昌市",
				"武威市", "酒泉市", "张掖市", "定西市", "天水市", "白银市", "平凉市", "临夏回族自治州", "庆阳市",
				"陇南市", "甘南藏族自治州" };
