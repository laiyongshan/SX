package suncere.shanxi.androidapp.utils;
...
//    }
    ...
    public void setCities (String Cities){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("AllCityCounts", Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public String  getAllCities(){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("AllCityCounts", Activity.MODE_PRIVATE);
        String   Cities=sharedPreferences.getString("Cities", "太原市");
        return Cities;
    }


    public void setCitiesCode (String Cities){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("AllCityCountsCode", Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("CitiesCode", Cities);
        editor.apply();
    }
    public String  getAllCitiesCode(){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("AllCityCountsCode", Activity.MODE_PRIVATE);
        String   Cities=sharedPreferences.getString("CitiesCode", "太原市");
        return Cities;
    }

    public void isShouwAllCity(boolean ishow){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("isShouwAllCityXML", Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean("isshow", ishow);
        editor.apply();
    }
    public boolean  getisShouwAllCity(){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("isShouwAllCityXML", Activity.MODE_PRIVATE);
        boolean  ishow=sharedPreferences.getBoolean("isshow", true);
        return ishow;
    }


    public void setFollowCities (String  followCities){ // 关注的城市
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("FollowCities", Activity.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString("followCities", followCities);
        editor.apply();
    }
    public String  getFollowCities(){
        SharedPreferences sharedPreferences = mContext.getSharedPreferences("FollowCities", Activity.MODE_PRIVATE);
        String  followCities=sharedPreferences.getString("followCities","太原市");
        return followCities;
    }
