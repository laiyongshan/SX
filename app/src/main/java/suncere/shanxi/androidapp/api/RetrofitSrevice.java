package suncere.shanxi.androidapp.api;
...
//    http://111.75.227.199:8081/AppServerTest/api/CityData/GetHourData?cityCode=360100&StationTypeID=3
    ...
    @GET("CityData/GetDistrictHourData")
    Observable<CityStationModel> getCityStationData(@Query("cityCode") String cityCode);
    ...
    //3城市对比
    @GET("CityData/GetCityChar")
    Observable<List<CityCharBean>> getCityCompareData(@Query("cityName") String cityName,@Query("TimeType")String TimeType,@Query("countIndex")String countIndex,@Query("PollutantCode")String PollutantCode);

    @GET("CityData/GetPMCityChar")
    Observable<List<PolluteCompareBean>> getPolluteCompareData(@Query("cityName") String cityName, @Query("TimeType")String TimeType, @Query("countIndex")String countIndex, @Query("PollutantCode")String PollutantCode);
    ...
    @GET("CityData/GetCityHourChar")
    Observable<List<CityHourCharBean>> getCityHourChar(@Query("cityName") String cityName, @Query("Stime")String Stime, @Query("Etime")String Etime);
}
