...
public class TagAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_flow_tv, null);

        PollutantNameTextView textView = (PollutantNameTextView) view.findViewById(R.id.tv_tag);
